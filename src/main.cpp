...
const string strMessageMagic = "Element-94 Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Element-94
    bool fStrictPayToScriptHash = true; // Always active in Element-94
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Element-94", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
// If genesis block hash does not match, then generate new genesis hash.
		...
		assert(block.GetHash() == (!fTestNet true hashGenesisBlock : hashGenesisBlockTestNet));
